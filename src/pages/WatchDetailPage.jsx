      ...
      <main className="container detail-layout">
        ...
        <section className="detail-panel">
          ...
          <ul className="spec-list">
            <li><span>Mouvement</span><span>{watch.movement}</span></li>
            <li><span>Calibre</span><span>{watch.caliber}</span></li>
            <li><span>Boitier</span><span>{watch.case}</span></li>
            <li><span>Reserve</span><span>{watch.reserve}</span></li>
            <li><span>Etancheite</span><span>{watch.waterResistance}</span></li>
          </ul>
