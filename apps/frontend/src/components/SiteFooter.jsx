            ...
            <div className="mx-auto grid max-w-360 grid-cols-[1.2fr_1fr_1fr_1fr] gap-8 max-lg:grid-cols-2 max-[700px]:grid-cols-1">
                ...
                <div className="flex flex-col gap-2.5">
                    ...
                    <form className="flex flex-col gap-3.5">
                        <input type="email" placeholder="Votre adresse email" className="border-b border-[#8c8d8e] bg-transparent px-0 py-2 text-sm text-[#faf8f5] outline-none transition-colors duration-200 hover:border-[#faf8f5] focus:border-[#faf8f5]" />
                        <button type="submit" className="inline-flex items-center gap-1.5 self-start bg-transparent p-0 text-[11px] uppercase tracking-widest text-[#faf8f5] transition-colors duration-200 hover:text-[#d5c7b2]">
                            Rejoindre
